...
<body id="textcolor"> 
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                  <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="warp-public.php">Warp</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="jumbotron bg-banner">
            <div class="container text-center "><br><br><br>
                <h1 class="display-2 txt-white">ERROR 404 <br> </h1><br>
            </div></div>
        <div class="jumbotron bg-ban-2 text-center">
        <button type="button" class="btn btn-light"><a onclick="goBack()" href="#"><h1 class="txt-de-h1"><ins>ย้อนกลับไปก่อนหน้านี้</ins></h1></a></button>          
            <div class="text-center"><img src="img/logo/warp-di-404.png" class="img-fluid" alt="Responsive image"></div>
        </div>
        <script>
        function goBack() {
           window.history.back();
