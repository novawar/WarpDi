...
<body id="textcolor"> 
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            ...
            <div class="container text-center "><br><br><br>          
                <h2 class="display-8 txt-white">แก้ไข<br></h2>   
            </div></div>
      ...
      <input type="hidden" name="topic_id" value="<?php echo $request; ?>">
          <div class="container form-group col-md-6">
              <label class="txt-de-h1">หัวข้อ</label>
              <input type="text" value="<?php echo $row["topic"]; ?>" class="form-control" name="topic" maxlength="50" required>
          </div>
          <div class="container form-group col-md-6">
              <label class="txt-de-h1">รายละเอียด</label>
              <textarea type="text" class="form-control" name="detail" maxlength="500" required name><?php echo $row["detail"]; ?></textarea>
          </div>
          <div class="container form-group col-md-6">
              <label class="txt-de-h1">ที่อยู่วาร์ป <p class="text-secondary">ตัวอย่างเช่น : https://www.website.com</p></label>
              <input type="url" maxlength="125"  value="<?php echo $row["warp"]; ?>" class="form-control" name="warp"  required>
          </div>
          <div class="container form-group col-md-6">
          ...
          <div class="col-md-12 cur">
              <button type="submit" class="btn btn-success mx-auto btn-lg w-50 d-block button-green" style="width: 200px; height:60px"> <h4>บันทึก </h4></button><br>         
