...
<?php
  ...
  if($CHECK_SESSION == !"")
  { 
    echo '<script>window.location.href = "index-warpdi.php";</script>';  
  }
?>
<html>
...
<body id="textcolor"> 
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                  ...
                  <form class="form-inline my-2 my-lg-0"  method="post" action="db_login.php">
        ...
        <div class="jumbotron bg-banner">
            <div class="container text-center "><br><br><br>
                ...
                <p><a href="warp-public.php" class="btn btn-warning btn-lg txt-de-h1 button-yel border border-white">Let's go »</a></p>     
            </div></div>
