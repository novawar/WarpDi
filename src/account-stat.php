...
<head>
	<meta charset="utf-8">
    <title>Admin Panel : Account Stat</title>
	...
	<script>
		...
		function showTable(result) {
			if(result){
				...
				if(len>0){
					for(var i=0;i<len;i++){
						txt += "<tr><td>"+(i+1)+"</td><td>"+result[i][0]+"</td><td>"+result[i][1]+"</td><td>"+result[i][2]+"</td><td>"+result[i][3]+"</td><td>"+result[i][4]+"</td><td><a href='del_account.php?u_id="+result[i][0]+"''><i class='fa fa-trash text-danger' aria-hidden='true'></i></a></td></tr>";
					}
					if (txt != "") {
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        ...
        <div class="container text-right"><p><a href="add-account.php" class="btn btn-warning btn-md txt-de-h1 button-yel border border-white"><i class="fa fa-user-o" style="font-size:15px">+</i>&nbsp;เพิ่มสมาชิก</a></p></div>
        <div class="container text-right">
        <h3 class="display-8 txt-de-h1">รายการบัญชีทั้งหมด<br></h3><br>     
        <h5 class="display-8 txt-de-h1 text-danger">**โปรดระวัง!! การลบสมาชิกสามารถทำได้ในครั้งเดียวโดยไม่ต้องทำการยืนยัน!<br></h5> </div>
        <div class="container">
