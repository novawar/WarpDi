        ...
        <div class="jumbotron bg-banner">
            ...
            <div class="container">
                        <div class="row">
                            ...
                            <a href="account-stat.php"><img class="rounded-circle img-fluid" alt="Responsive image" src="img/logo/account.png"  width="150" height="150"></a><br><br>
                            <h2 class="card-title txt-de-h1"><a  href="account-stat.php">จัดการสมาชิก</a></h2> 
                            </div>
                            <div class="col-md-4 col-sm-6 text-center boxhead">    
                            <a href="warp-stat.php"><img class="rounded-circle img-fluid" alt="Responsive image " src="img/logo/setting.png"  width="150" height="150"></a><br><br>   
                            <h2 class="card-title txt-de-h1"><a  href="warp-stat.php" >จัดการวาร์ป</a></h2>
                            </div>
